    ...
    try {
      ...
      out.write("        ");
            ...
            if (request.getParameter("sub") != null) {
                ...
                Connection conn = DriverManager.getConnection(url + database, user, pass);//链接数据库

                String dluser = request.getParameter("user");
                ...
                if (yzm.equals(dlyzm)) {
                    ...
                    int dltype = Integer.valueOf(request.getParameter("usertype"));
                    ...
                    if (rs.next()) {
                        if (dlpass.equals(rs.getString(1))) {
                            out.print("<script>alert('登录成功！');</script>");//弹出对话框
                        } else {
      ...
      out.write("                    </table>\n");
      out.write("                </div>\n");
      out.write("                老师登录<input name=\"usertype\" type=\"radio\" value=\"1\" /> 学生登录<input name=\"usertype\" type=\"radio\" value=\"0\" />\n");
      out.write("                ");
      out.write("\n");
      out.write("                <script>document.getElementsByName(\"usertype\")[1].checked = \"checked\";</script><br/>\n");
